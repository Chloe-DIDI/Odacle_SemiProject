...
UPDATE TBL_COURSE
SET STARTDATE = TO_DATE('2021-07-01','YYYY-MM-DD')
,ENDDATE = TO_DATE('2021-09-30','YYYY-MM-DD')
WHERE COUR_CODE='개발자A';
--○ 과정 데이터 입력
INSERT INTO TBL_COURSE(COUR_CODE, CLASS_CODE, STARTDATE, ENDDATE, LIMIT) 
VALUES ('개발자A', 1, TO_DATE('2021-07-01','YYYY-MM-DD'), TO_DATE('2021-09-30','YYYY-MM-DD'), 15);
INSERT INTO TBL_COURSE(COUR_CODE, CLASS_CODE, STARTDATE, ENDDATE, LIMIT) 
...
SET STARTDATE = TO_DATE('2021-07-01','YYYY-MM-DD')
,ENDDATE = TO_DATE('202-07-31','YYYY-MM-DD')
WHERE OPSUB_CODE=10001;

UPDATE TBL_OPSUBJECT
SET STARTDATE = TO_DATE('2021-08-01','YYYY-MM-DD')
,ENDDATE = TO_DATE('2021-08-31','YYYY-MM-DD')
WHERE OPSUB_CODE=10002;

UPDATE TBL_OPSUBJECT
SET STARTDATE = TO_DATE('2021-09-01','YYYY-MM-DD')
,ENDDATE = TO_DATE('2021-09-30','YYYY-MM-DD')
WHERE OPSUB_CODE=10003;

--○ 개설과목 데이터 입력
INSERT INTO TBL_OPSUBJECT(OPSUB_CODE, COUR_CODE, SUB_CODE, PRO_ID, ALLOT_CODE, STARTDATE, ENDDATE) 
VALUES (10001, '개발자A', 1, 'hjkim', 5, TO_DATE('2021-07-01','YYYY-MM-DD'), TO_DATE('2020-07-31','YYYY-MM-DD'));
INSERT INTO TBL_OPSUBJECT(OPSUB_CODE, COUR_CODE, SUB_CODE, PRO_ID, ALLOT_CODE, STARTDATE, ENDDATE) 
