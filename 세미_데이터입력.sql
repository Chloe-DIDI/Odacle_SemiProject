...
VALUES (10001, '개발자A', 1, 'hjkim', 5, TO_DATE('2020-12-01','YYYY-MM-DD'), TO_DATE('2020-12-31','YYYY-MM-DD'));
INSERT INTO TBL_OPSUBJECT(OPSUB_CODE, COUR_CODE, SUB_CODE, PRO_ID, ALLOT_CODE, STARTDATE, ENDDATE) 
...
INSERT INTO TBL_QUIT(QUIT_CODE, REG_CODE, REASON, QUIT_DATE)
    VALUES(1, 4, '취업함.','2021-07-01');
    
    
--○ 관리자
INSERT INTO TBL_ADMIN(ADMIN_ID, PW, NAME) VALUES ('yunnau', '1111', '임윤아');
INSERT INTO TBL_ADMIN(ADMIN_ID, PW, NAME) VALUES ('kangzzun', '1010', '서강준');
